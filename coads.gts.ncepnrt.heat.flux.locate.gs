...
*
*     grads -blc "coads.gts.ncepnrt.heat.flux.locate all.flux.locate"
*
* - RD November 2012
...
obsx = refx+0.2 ; obsy = refy-0.2 ; "set line 13" ; "draw mark 3 "obsx" "obsy" "dotsiz ; "draw string "obsx+0.1" "obsy" `3<`010`a3`n"
obsx = refx+1.3 ; obsy = refy-0.2 ; "set line 11" ; "draw mark 3 "obsx" "obsy" "dotsiz ; "draw string "obsx+0.1" "obsy" `3<`010`a4`n"
